    ...
    <section className="py-12 sm:py-16 md:py-20 pb-0 relative bg-gray-50" id="features" ref={sectionRef}>
      <div className="section-container">
        <div className="text-center mb-10 sm:mb-16">
          ...
          <h2 className="font-revamped-bold text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight mb-3 sm:mb-4 opacity-0 fade-in-element">
            Services That <br className="hidden sm:block" />Drive Success
          </h2>
          <p className="section-subtitle mx-auto opacity-0 fade-in-element">
            Transform your business with AI-powered solutions that save time, reduce costs, and boost productivity.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          ...
          <FeatureCard
            ...
            description="Professional graphic design services that create compelling visual identities and marketing materials."
            index={2}
          />
          <FeatureCard
            ...
            description="Comprehensive system design and architecture planning to ensure scalable and efficient technology solutions."
            index={3}
          />
          <FeatureCard
            ...
            title="RAG Systems"
            description="Retrieval-Augmented Generation systems that enhance AI responses with real-time, accurate information."
            index={4}
          />
          <FeatureCard
            ...
            description="Custom software solutions to streamline operations, manage resources, and optimize business processes."
            index={5}
          />
        </div>
      </div>
